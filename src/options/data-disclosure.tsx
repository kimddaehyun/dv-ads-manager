...
const COLLECTED: Row[] = [
  ...
  },
  {
    ...
    use: "다계정 대시보드·광고 성과 측정 등에서 사용자별 설정 유지",
    destination: "사내 서버(Supabase) 저장",
  },
  {
    data: "광고 계정별 어제 성과·비즈머니 잔액",
    use: "다계정 대시보드 목록 표시",
    destination: "사용자 브라우저에만 저장 - 외부 전송 없음",
  },
  {
    data: "계정 이슈 기록 (예산 소진·다른 사람의 광고 수정 이력)",
    use: "계정 이슈 알림 표시 및 기기를 바꿔도 이어보기",
    destination: "사내 서버(Supabase) 저장 - 60일 뒤 자동 삭제",
  },
];
