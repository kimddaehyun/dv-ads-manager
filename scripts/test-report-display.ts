...
// 21 헤더, 22-23 웹사이트전환 2캠페인, 24 소계, 25 카탈로그, 26 소계, 27 전체합계
...
ok(/<c r="C24"[^>]*><is><t[^>]*>소계<\/t>/.test(s7), "섹션2 웹사이트전환 소계행(C24)");
ok(/<c r="D24"[^>]*><v>1053000<\/v>/.test(s7), "섹션2 소계 노출=643000+410000=1053000(D24)");
ok(/<c r="B25"[^>]*><is><t[^>]*>카탈로그<\/t>/.test(s7), "섹션2 카탈로그 유형(B25)");
ok(/<c r="B27"[^>]*><is><t[^>]*>전체 합계<\/t>/.test(s7), "섹션2 전체합계행(B27)");
ok(/<c r="D27"[^>]*><v>1343000<\/v>/.test(s7), "섹션2 전체합계 노출=1053000+290000=1343000(D27)");
ok(/<mergeCell ref="B27:C27"\/>/.test(s7), "섹션2 전체합계 병합(B27:C27)");
// 직접/간접 전환(N/O) '-' 표기
ok(/<c r="N22"[^>]*t="inlineStr"[^>]*><is><t[^>]*>-<\/t>/.test(s7), "섹션2 직접전환(N22)='-'");
ok(/<c r="O22"[^>]*t="inlineStr"[^>]*><is><t[^>]*>-<\/t>/.test(s7), "섹션2 간접전환(O22)='-'");
ok(/<c r="N27"[^>]*t="inlineStr"[^>]*><is><t[^>]*>-<\/t>/.test(s7), "섹션2 전체합계 직접전환(N27)='-'");
