...
// 22-23 파워링크 캠페인A 2그룹(C22:C23 병합), 24 소계, 25 쇼핑 캠페인C, 26 소계, 27 전체합계
...
ok(/<c r="C24"[^>]*><is><t[^>]*>소계<\/t>/.test(s3), "검색광고 파워링크 소계행(C24=소계)");
ok(/<c r="E24"[^>]*><v>63000<\/v>/.test(s3), "검색광고 파워링크 소계 노출=25000+38000=63000(E24)");
ok(/<c r="B27"[^>]*><is><t[^>]*>전체 합계<\/t>/.test(s3), "검색광고 전체합계행(B27)");
ok(/<mergeCell ref="B27:D27"\/>/.test(s3), "검색광고 전체합계 라벨 병합 3열(B27:D27)");
ok(/<c r="E27"[^>]*><v>103000<\/v>/.test(s3), "검색광고 전체합계 노출=63000+40000=103000(E27)");
