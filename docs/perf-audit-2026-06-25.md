...
- **위치:** `src/features/bid/index.ts:159-167`(ensureBadge 기존 mount 분기), `191-251`(renderBadge), `1084-1090`(schedule), `1109-1110`(body observer); poll 가산 `944, 1007`
...
- **위치:** `src/features/bid/index.ts:911-918`(schedulePoll), `920-1008`(poll)
...
- **위치:** `src/features/multi-account/multi-account.ts:46-47`(정적 import) + `setup-excel.ts:15` + `report.ts:11` / 호출부 `multi-account.ts:1262·1512·1522`
...
- **위치:** `src/features/report/report.ts:107-137`(114-123 for 루프)
...
- **위치:** `src/features/report/report-build.ts:394-429, 457-458`
...
- **위치:** `src/features/setup/setup.ts:352`(set) vs `359`(get)
...
- **위치:** `src/features/multi-account/multi-account.ts:1765-1822`, `src/features/multi-account/multi-account-storage.ts:118-124`
...
- **위치:** `src/shared/searchad.ts:33-66, 280-311, 443-472`, `src/background/index.ts:288-323`
...
- **위치:** `src/features/period-compare/period-compare.ts:308-327`(mountButton), `219-251`(findDateRangeContainer)
...
- **위치:** `src/features/report/report-excel.ts:64-108`(replaceCell/setNumber/setString), `515-559`(centerCells/addCenteredStyle), `src/features/report/report-fill.ts`, `src/features/report/report-variable.ts`
...
- **위치:** `src/features/bid/index.ts:309-371`, `src/features/period-compare/period-compare.ts:451-456`
...
- **위치:** `src/features/bid/index.ts:902,1109-1120`, `src/features/period-compare/period-compare.ts:1229-1242`, `src/features/asset-bulk/asset-bulk.ts:41`, `src/features/asset-bulk/shopping-image-import.ts:68`
...
- **위치:** `src/shared/cache-prune.ts:38-61`
...
- **위치:** `src/features/multi-account/multi-account-data.ts:290-309`(fetchYesterdayStats 청크 직렬), `491-551`(collectAccount)
...
- **위치:** `src/features/asset-bulk/shopping-image-import.ts:66-81`
...
- **위치:** `src/features/bid/volume-cache.ts:22-35`, `src/features/bid/performance-cache.ts:27-33`
...
- **위치:** `src/features/multi-account/multi-account.ts:251-283`(findOperationChip)
